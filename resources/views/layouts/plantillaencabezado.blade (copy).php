...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <h1>fuera</h1>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">{{ __('Login11') }}</a>
            </li>
            @if (Route::has('register'))
            <li class="nav-item">
                <a class="nav-link" href="{{ route('register') }}">{{ __('Register11') }}</a>
            </li>
            @endif
            @else
            <h1>dentro</h1>
            ...
            <a class="mr-3 ml-3" href="">nuevos ingresos</a>
            <a class="mr-3" href="">ingresar</a>
            <a class="ins-ic">
